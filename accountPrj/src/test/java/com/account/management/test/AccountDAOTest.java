...
public class AccountDAOTest {
	...
	//	System.out.println(student1.getStudentId());
		acctFromDb = accountDAO.createAccount(student1);
		System.out.println("acct"+ acctFromDb.getId());	
		assertNotNull(acctFromDb);
		assertEquals(setupAccount.getId(), acctFromDb.getId());
	}
	
	@Test
	public void testRetrieveBalance() {

		double balance = accountDAO.retrieveBalance(setupAccount.getId());
		
	//	System.out.println("bal" + balance);
		assertEquals(setupAccount.getBalanceDue(), balance,0.0);
	}
